      ...
      : ((e = e.add(this.parent())),
        this.each(function () {
          function i(t) {
            n.clearTimeout(a),
              ...
              (s = n.setTimeout(function () {
                e.find(":focus").blur(),
                  h.instantlyCloseOthers === !0 && e.removeClass("open"),
                  n.clearTimeout(s),
          ...
          l.hover(
            function (o) {
              return (
                (!l.hasClass("open") && !r.is(o.target)) ||
                void (t(n).width() > 767 && i(o))
              );
            },
            function () {
              t(n).width() > 767 &&
  ...
  (function (t) {
    ...
    (t.expr[":"].notmdproc = function (n) {
      ...
      (t.material = {
        ...
        checkbox: function (n) {
          var o = t(n ? n : this.options.checkboxElements)
            .filter(":notmdproc")
            .data("mdproc", !0)
            .after(
              "<span class='checkbox-zncn'><span class='check'></span></span>"
            );
          e(o);
        },
        togglebutton: function (n) {
          var o = t(n ? n : this.options.togglebuttonElements)
            .filter(":notmdproc")
            .data("mdproc", !0)
        ...
        radio: function (n) {
          var o = t(n ? n : this.options.radioElements)
            .filter(":notmdproc")
            .data("mdproc", !0)
        ...
        input: function (n) {
          t(n ? n : this.options.inputElements)
            .filter(":notmdproc")
            .data("mdproc", !0)
            .each(function () {
              var n = t(this),
              ...
              (null !== n.val() && "undefined" != n.val() && "" !== n.val()) ||
                o.addClass("is-empty"),
                o.append("<span class='material-input'></span>"),
                o.find("input[type=file]").length > 0 &&
                  o.addClass("is-fileinput");
            });
        },
          ...
          t(document)
            ...
            .on("keyup change", ".form-control", function () {
              var n = t(this),
                o = n.closest(".form-group"),
                i =
                  "undefined" == typeof n[0].checkValidity ||
                  n[0].checkValidity();
              "" === n.val()
                ? o.addClass("is-empty")
                : o.removeClass("is-empty"),
                e && (i ? o.removeClass("has-error") : o.addClass("has-error"));
            })
            .on(
              "focus",
            ...
            .on(
              ...
              function () {
                ...
                t.each(this.files, function (t, n) {
                  ...
                  e ? o.removeClass("is-empty") : o.addClass("is-empty"),
                  o.find("input.form-control[readonly]").val(e);
              }
            );
        },
        ripples: function (n) {
        ...
        init: function (n) {
          ...
          t.fn.ripples && this.options.ripples && this.ripples(),
            ...
            document.arrive &&
              ...
              this.options.input &&
                o.arrive(this.options.inputElements, function () {
                  t.material.input(t(this));
                }),
              this.options.checkbox &&
                o.arrive(this.options.checkboxElements, function () {
                  t.material.checkbox(t(this));
                }),
              this.options.radio &&
                o.arrive(this.options.radioElements, function () {
                  t.material.radio(t(this));
                }),
              this.options.togglebutton &&
                o.arrive(this.options.togglebuttonElements, function () {
    ...
    (i.prototype.init = function () {
      ...
      o.on("mousedown touchstart", function (e) {
        if (!s.isTouch() || "mousedown" !== e.type) {
          o.find(".ripple-container").length ||
            o.append('<div class="ripple-container"></div>');
          ...
          if (a || r) {
            ...
            c
              ...
              o.on("mouseup mouseleave touchend", function () {
      ...
      (i.prototype.getNewSize = function (t, n) {
        return (
          (Math.max(t.outerWidth(), t.outerHeight()) / n.outerWidth()) * 2.5
        );
      }),
      (i.prototype.getRelX = function (t, n) {
        ...
        return s.isTouch()
          ? ((n = n.originalEvent),
            1 === n.touches.length && n.touches[0].pageX - o.left)
          : n.pageX - o.left;
      }),
      (i.prototype.getRelY = function (t, n) {
        ...
        return s.isTouch()
          ? ((n = n.originalEvent),
            1 === n.touches.length && n.touches[0].pageY - o.top)
          : n.pageY - o.top;
      }),
      (i.prototype.getRipplesColor = function (t) {
        var o = t.data("ripple-color")
          ? t.data("ripple-color")
          : n.getComputedStyle(t[0]).color;
        return o;
      }),
      ...
      (t.fn.ripples = function (n) {
        return this.each(function () {
          t.data(this, "plugin_" + a) ||
            t.data(this, "plugin_" + a, new i(this, n));
        });
      });
